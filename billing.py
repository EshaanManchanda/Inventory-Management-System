...
class billClass: #we are make class here
    def __init__(self,root): #this is defaule constructor. root is the object
        ...
        self.root.geometry("1370x700+0+0") #it is used to define size of the frame or window
        ...
        title=Label(self.root,text="Inventory Management System", image=self.icon_title ,compound=LEFT,font=("times new roman",40,"bold"),bg="#048EF9",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        lbl_pname=Label(ProductFrame2,text="Product Name", font=("times new roman",15,"bold"),bg="white").place(x=2,y=45)
        ...
        lbl_note=Label(ProductFrame1,text="Note: 'Enter 0 QTY to remove the product from cart'",font=("goudy old style",10),anchor="w",bg="white",fg="red").pack(side=BOTTOM,fill=X)
        ...
        lbl_name=Label(customerFrame,text="Name", font=("times new roman",15)).place(x=5,y=35)
        txt_name=Entry(customerFrame,textvariable=self.var_cname, font=("times new roman",13),bg="lightyellow").place(x=80,y=35,width=150)
        
        lbl_contact=Label(customerFrame,text="Contact No.", font=("times new roman",15)).place(x=250,y=35)
        txt_contact=Entry(customerFrame,textvariable=self.var_contact, font=("times new roman",13),bg="lightyellow").place(x=360,y=35,width=150)
        ...
        self.text_cal_input=Entry(calFrame,textvariable=self.var_cal_input,font=("arial",15,'bold'),width=21,bd=10,relief=GROOVE,state='readonly',justify=RIGHT)
        ...
        btn_subtract=Button(calFrame,text="-",font=("arial",15,'bold'),command=lambda:self.get_input("-"),bd=5,width=4,pady=10,cursor="hand2").grid(row=2,column=3)
        ...
        btn_eq=Button(calFrame,text="=",font=("arial",15,'bold'),command=self.perform_cal,bd=5,width=4,pady=15,cursor="hand2").grid(row=4,column=2)
        ...
        txt_p_name=Entry(Add_cart_widgetsFrame,textvariable=self.var_pname,font=("times new roman",15),bg="lightyellow", state='readonly').place(x=5,y=35,width=190,height=22)
        
        lbl_p_price=Label(Add_cart_widgetsFrame, text="Price Per Qty",font=("times new roman",15),bg="white").place(x=230,y=5)
        txt_p_price=Entry(Add_cart_widgetsFrame,textvariable=self.var_price,font=("times new roman",15),bg="lightyellow", state='readonly').place(x=230,y=35,width=150,height=22)
        
        lbl_p_qty=Label(Add_cart_widgetsFrame, text="Quantity",font=("times new roman",15),bg="white").place(x=390,y=5)
        txt_p_qty=Entry(Add_cart_widgetsFrame,textvariable=self.var_qty,font=("times new roman",15),bg="lightyellow").place(x=390,y=35,width=120,height=22)
        
        self.lbl_instock=Label(Add_cart_widgetsFrame, text="In Stock",font=("times new roman",15),bg="white")
        self.lbl_instock.place(x=5,y=70)
        
        btn_clear_cart=Button(Add_cart_widgetsFrame, text="Clear",command=self.clear_cart,font=("times new roman",15,"bold"),bg="lightgray",cursor="hand2").place(x=180,y=70,width=150,height=30)
        btn_Add_cart=Button(Add_cart_widgetsFrame, text="Add | Update Cart",command=self.add_update,font=("times new roman",15,"bold"),bg="orange",cursor="hand2").place(x=340,y=70,width=180,height=30)
        ...
        #===========Footer =================================
        footer=Label(self.root,text="IMS-Inventory Management System | Developed by Tech Love V \n For any Technical Issue contact:83*******0",font=("times new roman",11),bg="#4d636d",fg="white",bd=0,cursor="hand2").pack(side=BOTTOM,fill=X)
...
#=================================All funtions =================================================
    ...
    def bill_update(self):
        ...
        self.cartTitle.config(text=f'Total Product: {str(len(self.cart_list))}')
