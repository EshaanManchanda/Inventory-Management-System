...
class IMS: #we are make class here
    def __init__(self,root):#this is defaule constructor. root is the object
        ...
        LeftMenu.place(x=0,y=100,width=200,height=568)
        ...
        lbl_menu=Label(LeftMenu,text="Menu",font=("times new roman",20),bg="#048EF9").pack(side=TOP,fill=X)
        
        #====Left menu buttons =================================================
        
        btn_employee=Button(LeftMenu,text="Employee",command=self.employee,image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        
        btn_supplier=Button(LeftMenu,text="Suppliers",command=self.supplier,image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        ...
        #this is supplier
        self.lbl_supplier=Label(self.root,text="Total Supplier\n[0]",bd=5,relief=RIDGE,bg="#0D04F9",fg="white",font=("times new roman",20,"bold"))
        self.lbl_supplier.place(x=650,y=120,height=150,width=300)
        
        #this is for category
        self.lbl_category=Label(self.root,text="Total Category\n[0]",bd=5,relief=RIDGE,bg="#5F0A87",fg="white",font=("times new roman",20,"bold"))
        self.lbl_category.place(x=1000,y=120,height=150,width=300)
        
        #this is for produces
        self.lbl_products=Label(self.root,text="Total Products\n[0]",bd=5,relief=RIDGE,bg="#52924C",fg="white",font=("times new roman",20,"bold"))
