...
class supplierClass: #we are make class here
    def __init__(self,root):#this is defaule constructor. root is the object
        ...
        btn_search=Button(self.root,text="Search",command=self.search,font=("goudy old style",15),cursor="hand2",bg="#4caf50",fg="white").place(x=980,y=79,width=100,height=28)
        ...
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),cursor="hand2",bg="#2196f3",fg="white").place(x=180,y=370,width=110,height=35)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),cursor="hand2",bg="#4caf50",fg="white").place(x=300,y=370,width=110,height=35)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),cursor="hand2",bg="#f44336",fg="white").place(x=420,y=370,width=110,height=35)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),cursor="hand2",bg="#607d8b",fg="white").place(x=540,y=370,width=110,height=35)
        ...
        self.supplierTable.column("invoice",width=40)
    ...
    def add(self):
        ...
        try:
            if self.var_sup_invoice.get()=="" or self.var_name.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","This Invoice No. already assigned , try different one",parent=self.root)
                else:
            ...
            if self.var_sup_invoice.get()=="" or self.var_name.get()=="":
                ...
                if row==None:
                    ...
                    if op==True:
                        ...
                        con.commit()
                        messagebox.showinfo("Delete","Supplier Delete Successfully")
...
if __name__ == "__main__":
    ...
    obj=supplierClass(root)#making obj  object of IMS class, passig   root to attache with tk class
